...
pub trait NodeAcceptorExt: Node {
    fn accept_inner<V: crate::writer::Visitor>(&self, prev_position: &Chess, visitor: &mut V);
    fn accept<V: crate::writer::Visitor>(&self, initial_position: &Chess, visitor: &mut V);
}

impl<N: Node> NodeAcceptorExt for N {
    fn accept_inner<V: crate::writer::Visitor>(&self, prev_position: &Chess, visitor: &mut V) {
    ...
    fn accept<V: crate::writer::Visitor>(&self, initial_position: &Chess, visitor: &mut V) {
        ...
        for variation_node in variation_node_vec {
            if let crate::writer::Skip(true) = visitor.begin_variation() {
